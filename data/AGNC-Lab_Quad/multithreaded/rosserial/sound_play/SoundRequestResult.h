#ifndef _ROS_sound_play_SoundRequestResult_h
#define _ROS_sound_play_SoundRequestResult_h
...
namespace sound_play
{
  ...
  class SoundRequestResult : public ros::Msg
  {
    public:
      bool playing;
      ros::Time stamp;
    ...
    const char * getType(){ return "sound_play/SoundRequestResult"; };
