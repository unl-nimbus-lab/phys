...
class WIDL
{
...
#endif	
	{
		...
		//varnoise_obs_thetaCOMPASS = pow( PI/180.0f, 2);
#endif
...
*/
	...
	void callback_compass(geometry_msgs::Pose2D compassPose)
	{
		...
		if( (currentvalue < -1.0f && lastvalue > 1.0f) )
		{
			dtheta = -((-PI)-currentvalue)+(PI-lastvalue);
		}
		else if(currentvalue > 1.0f && lastvalue < -1.0f)
		{
		...
		//BTW : this way of solving it isn't right at all because it aims at the explosion of the stae...
		*/
