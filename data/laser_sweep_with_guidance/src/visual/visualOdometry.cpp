...
void camDataHandler(const nav_msgs::Odometry::ConstPtr& Data)

{

  voData.header.stamp = Data->header.stamp;
flag = true;
}
int main(int argc, char** argv)
{
 ...
 ros::Subscriber camDataSub = nh.subscribe<nav_msgs::Odometry> 
                              ("/cam_to_init3", 1, camDataHandler);
