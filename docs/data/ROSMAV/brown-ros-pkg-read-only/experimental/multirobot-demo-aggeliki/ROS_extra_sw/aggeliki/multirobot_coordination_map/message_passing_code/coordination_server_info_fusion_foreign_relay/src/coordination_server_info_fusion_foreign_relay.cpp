#include "coordination_server_info_fusion_foreign_relay.h"
...
void loadMap()
{
   ...
   //INPUT THE MAP IN THE FORM OF NODES
	...
	Node* n6 = new Node(5, 8.5, 13);
	Node* n7 = new Node(6, 10, 13);
	Node* n8 = new Node(7, 11.5, 13);
	Node* n9 = new Node(8, 13, 13);

	//-- intermediate nodes, corridor 2 --
	Node* n10 = new Node(9, 15, 11.5);
	Node* n11 = new Node(10, 15, 10);
	Node* n12 = new Node(11, 15, 8.5);

	//-- intermediate nodes, corridor 3 (DON'T CARE FOR NOW) --
	Node* n13 = new Node(12, 16.5, 7);
	Node* n14 = new Node(13, 18, 7);
	Node* n15 = new Node(14, 19.5, 7);
	Node* n16 = new Node(15, 21, 7);
	Node* n17 = new Node(16, 22.5, 7);
	Node* n18 = new Node(17, 24, 7);
