...
class JacoArm
{
 ...
 private:
    ...
    void normalizeAngles(std::vector<double> &angles);
    ...
    // Reusable memory for listening to buttons
    JoystickCommand joystick_command_;

    // Button press publishers
    ros::Publisher button1_publisher_;
    ros::Publisher button2_publisher_;
    ros::Publisher button3_publisher_;
    std_msgs::Bool bool_result_;
};
