#ifndef at_odom_sim_node_H
#define at_odom_sim_node_H
...
#include <at_odom_sim/at_odom_sim_paramsConfig.h>



/** \brief Implementation of at simulated odometry
 *
 * Implementation of at simulated odometry
 * 
 */
class AtOdomSimNode
{
