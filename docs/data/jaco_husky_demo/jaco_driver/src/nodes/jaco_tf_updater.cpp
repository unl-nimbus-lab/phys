    ...
    : kinematics_(node_handle)
{
    ...
    current_angles_.joint1 = 0.0;
    current_angles_.joint2 = 0.0;
    current_angles_.joint3 = 0.0;
    current_angles_.joint4 = 0.0;
    current_angles_.joint5 = 0.0;
    current_angles_.joint6 = 0.0;
...
void JacoTFTree::calculatePostion(void)
{
    ...
    kinematics_.updateForward(current_angles_.joint1,
                              current_angles_.joint2,
                              current_angles_.joint3,
                              current_angles_.joint4,
                              current_angles_.joint5,
                              current_angles_.joint6);
}
