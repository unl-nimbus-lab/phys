...
int main(int argc, char **argv)
{
  ...
  ros::Time imu_ts , Nav_ts ,pose_ts,posenav_ts,gpsraw_ts,navvel_ts, sonar_ts,alt_ts,des_nav_ts;
  imu_ts = Nav_ts =pose_ts=posenav_ts=gpsraw_ts=navvel_ts= sonar_ts=alt_ts=des_nav_ts=ros::Time::now();
